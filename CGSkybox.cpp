...
void CGSkybox::InitCubemap()
{
	...
	InitTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_X, "textures/skybox/Sorsele/posx.jpg");
	InitTexture(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, "textures/skybox/Sorsele/negx.jpg");
	InitTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, "textures/skybox/Sorsele/posy.jpg");
	InitTexture(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, "textures/skybox/Sorsele/negy.jpg");
	InitTexture(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, "textures/skybox/Sorsele/posz.jpg");
	InitTexture(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, "textures/skybox/Sorsele/negz.jpg");
